module PE3_128x512 (
    ...
    always@(posedge i_clk or negedge i_rst_n) begin
        if(!i_rst_n) begin
            ...
            o_done_delay<=2'b00;
            // r_addr_base <= 17'd724+17'd713+17'd670;
            r_addr_base <= 16'd926+16'd864+16'd870;
            ...
            if(ctrl_cnt!=2'd3)begin
                ...
                // r_addr_base <= (724+713+670+716)*i_layer_num;
                r_addr_base <= (926+864+870+701)*i_layer_num;
    ...
    weight_rownum_3 weight_rownum_mem (
        .clka(i_clk),        
        .rsta(!i_rst_n),        
        .ena(mux_en_row),        
        .wea(mux_we_row),        
