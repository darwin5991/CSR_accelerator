module PE1_128x512 (
    ...
    always@(posedge i_clk or negedge i_rst_n) begin
        if(!i_rst_n) begin
            ...
            if(ctrl_cnt!=2'd3)begin
                ...
                // r_addr_base <= (827+831+786+830)*i_layer_num;
                r_addr_base <= (907+853+833+647)*i_layer_num;
    ...
    weight_rownum_1 weight_rownum_mem (
        .clka(i_clk),        
        .rsta(!i_rst_n),        
        .ena(mux_en_row),        
        .wea(mux_we_row),        
